  ...
  firebase
    ...
    .onAuthStateChanged(function (user) {
      if (user) {
        ...
        // liveHpBaseStr = $("#char-hp-base-input").val().trim(); liveHpConStr =
        // $("#char-hp-con-input").val().trim(); liveHpRaceStr =
        // $("#char-hp-race-input").val().trim(); liveHpMax = (parseInt(liveHpBaseStr) +
        // parseInt(liveHpConStr) + parseInt(liveHpRaceStr));
        ...
        function newChar() {
          ...
          newCharName = $("#char-name-input")
            .val()
            .trim();
          newPlayerName = $("#player-name-input")
            .val()
            .trim();
          newGender = $("#char-gender-input")
            .val()
            .trim();
          newAgeStr = $("#char-age-input")
            .val()
            .trim();
          newAge = (parseInt(newAgeStr));
          newHeightFt = $("#char-ht-ft-input")
            .val()
            .trim();
          newHeightIn = $("#char-ht-in-input")
            .val()
            .trim();
          newHeight = ((parseInt(newHeightFt) * 12) + parseInt(newHeightIn));
          newWeightStr = $("#char-wt-input")
            .val()
            .trim();
          newWeight = (parseInt(newWeightStr));
          newRace = $("#char-race-input")
            .val()
            .trim();
          newExpStr = $("#char-exp-input")
            .val()
            .trim();
          newExp = (parseInt(newExpStr));
          newBack = $("#char-back-input")
            .val()
            .trim();
          newClass = $("#char-class-input")
            .val()
            .trim();
          newLevelStr = $("#char-level-input")
            .val()
            .trim();
          newLevel = (parseInt(newLevelStr));
          newHpBaseStr = $("#char-hp-base-input")
            .val()
            .trim();
          newHpConStr = $("#char-hp-con-input")
            .val()
            .trim();
          newHpRaceStr = $("#char-hp-race-input")
            .val()
            .trim();
        ...
        database
          ...
          .on("child_added", function (snapshot) {
            ...
            var newCharacter = "<div class='charLibcharDiv'><div class='charLibName'>" + snapshot
              .val()
              .charName + "</div><div>" + snapshot
              .val()
              .charRace + "</div><div>" + snapshot
              .val()
              .charClass + "</div><div>" + snapshot
              .val()
              .charLevel + "</div><div>" + snapshot
              .val()
              .charGender + "</div><div>" + snapshot
              .val()
              .playerName + "</div></div>";
